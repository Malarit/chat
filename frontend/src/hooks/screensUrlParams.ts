...
function screensUrlParams<T extends screens>(screen?: T, option?: iurls[T]) {
  ...
  return {
    ...
    setScreenOption<T extends screens>(screen?: T, option?: iurls[T]) {
      setSearchParams(option);
    },
  };
}

export default screensUrlParams;
